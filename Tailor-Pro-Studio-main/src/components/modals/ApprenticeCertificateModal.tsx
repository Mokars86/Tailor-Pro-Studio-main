          ...
          <div className="relative z-10 p-6 sm:p-8 md:p-10 space-y-4 flex flex-col justify-between h-full">
            ...
            <div className="flex flex-row items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-3 relative z-20">
                <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-[#061E1B] border-2 border-[#DCA134] overflow-hidden shadow-md flex items-center justify-center shrink-0">
                  <img
                    src={logoSrc}
